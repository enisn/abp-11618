...
public class MongoDbTestAppDbSchemaMigrator : ITestAppDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbTestAppDbSchemaMigrator(IServiceProvider serviceProvider)
    {
